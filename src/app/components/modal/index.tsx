...
export function Modal({ urlVideo, title }: ModalProps) {
  return (
    <div className="relative">
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed left-[50%] top-[50%] z-50  h-[100%] max-h-[52.5rem] min-h-[40.5rem] w-[100%] max-w-[38.125rem] translate-x-[-50%] translate-y-[-50%]  overflow-y-auto rounded-xl bg-white  mobile:rounded-none ">
        <Dialog.Close
